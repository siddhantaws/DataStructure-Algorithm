 ...
 * Input: n = 5   Output: Sum of digits in numbers from 1 to 5 = 15
 * Input: n = 12  Output: Sum of digits in numbers from 1 to 12 = 51
...
public class ComputeSumOfDigitsAllNumbersFrom1ToN {
    ...
    public ComputeSumOfDigitsAllNumbersFrom1ToN(int n) {
        this.n = n;
    }

    public static void main(String[] args) {
        ComputeSumOfDigitsAllNumbersFrom1ToN sum =new ComputeSumOfDigitsAllNumbersFrom1ToN(328);
        System.out.println(sum.sumOfDigitsFrom1ToN());
    }

    // Function to computer sum of digits in numbers from 1 to n. Comments use example of 328 to explain the code
    private int sumOfDigitsFrom1ToN(int n) {
    ...
    public int sumOfDigitsFrom1ToN(){
