...
public class ManacherAlgo {
    ...
    public ManacherAlgo(String str) {
    ...
    public static void main(String[] args) {
        ManacherAlgo manacherAlgo =new ManacherAlgo("babcbaabcbaccba");
        System.out.println(manacherAlgo.longestPalindromicSubstringLinear());
    }
}
