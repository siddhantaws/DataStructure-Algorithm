 ...
 */
public class MinimumTimeRequiredRotAllOranges {
    public static int R ;
    public static int C;

    private int arr[][];

    public MinimumTimeRequiredRotAllOranges(int[][] arr) {
        this.arr = arr;
        R=arr.length;
        C=arr[0].length;
    }
    ...
    public int rotOranges(){
        ...
        while(!Q.isEmpty()) {
            // This flag is used to determine whether even a single fresh orange gets rotten due to rotten oranges in current time
